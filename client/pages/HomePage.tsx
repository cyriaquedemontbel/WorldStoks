...
export const HomePage = ({ stocks, user, onStockSelect, onNavigate, isMarketUpdating, onOpenTradeModal, onUpdateMarket }: HomePageProps) => {
    ...
    return (
        <section className="home-page">
            <header className="home-page__header">
                ...
                <p className="intro-text">Investissez dans des actions basées sur des équipes, des personnalités et bien plus encore.</p>
            </header>

            <div className="search-bar-container">
                <svg className="search-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8zm0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6 2.691-6 6-6z"></path></svg>
                <input
                    type="search"
